	...
	return (
		<div className="container mb-5">
			...
			<div className="d-flex justify-content-center mt-5 single-view-mobile flex-column">
				<img src={`https://raw.githubusercontent.com/JorgeAJT/star-wars-reading-blog/master/src/img/starships/s${starship_uid}.jpg`} className="rounded-3"/>
			...
			<div className="d-flex justify-content-center mt-5 single-view">
				<img src={`https://raw.githubusercontent.com/JorgeAJT/star-wars-reading-blog/master/src/img/starships/s${starship_uid}.jpg`} className="rounded-3 single-img"/>
